...
const STATS = [
  ...
  { value: 'Partout en France', label: 'Loueurs partenaires' },
...
const FOR_WHO = [
  {
    ...
    desc:  'Gérez les demandes de VR pour vos assurés en panne ou accidentés. Prise en charge partielle ou totale.',
    color: 'bg-blue-500/15 text-blue-400',
  },
  {
    icon:  Building2,
    label: 'Agents d\'assurance',
    desc:  'Déclenchez rapidement un VR pour votre client assuré, selon les termes du contrat.',
    color: 'bg-violet-500/15 text-violet-400',
  },
  {
    icon:  Wrench,
    label: 'Garages & réparateurs',
    desc:  'Votre parc de courtoisie est insuffisant ? Trouvez un loueur partenaire en quelques clics.',
    color: 'bg-orange-500/15 text-orange-400',
  },
  {
    icon:  Truck,
    label: 'Loueurs indépendants',
    desc:  'Recevez des demandes qualifiées, répondez instantanément, gérez vos tarifs et disponibilités.',
...
const PORTALS = [
  {
    ...
    icon:        ShieldCheck,
    label:       'Espace Pro',
    description: 'Créez une demande en 2 minutes pour votre client. Recevez les réponses des loueurs proches en temps réel.',
  ...
  },
  {
    ...
    icon:        Truck,
    label:       'Espace Loueur',
    description: 'Recevez des demandes qualifiées, proposez vos tarifs et gérez vos disponibilités.',
...
const FEATURES = [
  { icon: Zap,       text: 'Mise en relation < 2 min' },
  { icon: MapPin,    text: 'Loueurs proches du client' },
  { icon: Clock,     text: 'Suivi en temps réel' },
  { icon: ShieldCheck, text: 'Prise en charge si besoin' },
  { icon: FileCheck, text: 'Documents & traçabilité' },
]
...
export default function HomePage() {
  return (
    <div className="relative min-h-screen bg-slate-950 flex flex-col overflow-hidden">
      ...
      {/* ── Contenu principal ── */}
      <main className="relative flex-1 flex flex-col items-center px-6 py-16 gap-14">
        ...
        <div className="flex flex-col items-center gap-5 text-center max-w-xl">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-md mx-auto">
              ...
              avec des loueurs indépendants disponibles près de leur client.
            </p>
          </div>
        ...
        <div className="w-full max-w-2xl">
          <p className="text-xs font-semibold text-slate-600 text-center uppercase tracking-widest mb-4">
            Pour qui ?
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {FOR_WHO.map(({ icon: Icon, label, desc, color }) => (
              <div
                key={label}
                className="flex items-start gap-3.5 p-4 rounded-2xl border border-slate-800 bg-slate-900/40"
              >
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${color}`}>
                  <Icon className="w-4.5 h-4.5" strokeWidth={2} />
                </div>
                <div>
                  <p className="text-sm font-bold text-slate-200 leading-snug">{label}</p>
        ...
        <div className="w-full max-w-lg space-y-3">
          <p className="text-xs font-semibold text-slate-600 text-center uppercase tracking-widest">
            Pas encore partenaire ?
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Assistance, assurance ou garage</p>
              </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Rejoindre le réseau DRIVES ON</p>
              </div>
