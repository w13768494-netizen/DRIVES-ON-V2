...
import {
  ...
  RefreshCw, Bell, Banknote, AlertTriangle, ShieldCheck, RotateCcw, Timer,
} from 'lucide-react'
...
const TIMELINE_ICONS: Record<TimelineEventType, React.ReactNode> = {
  ...
  relance_auto:              <Timer          className="w-4 h-4" />,
}
...
const TIMELINE_COLORS: Record<TimelineEventType, string> = {
  ...
  relance_auto:              'bg-violet-100  text-violet-700 border-violet-200',
}
